 ...
 * POST /api-proxy with body: { url, method?, headers?, body? }
 */
function vitePluginCorsProxy(): Plugin {
  return {
    name: "cors-proxy",
...
const plugins = [react(), tailwindcss(), vitePluginManusRuntime(), vitePluginCorsProxy(), vitePluginManusDebugCollector()];
